...
for(genome_path in genomes) {
  ...
  for(gaf_file in list.files(genome_path, pattern = ".gaf", full.names = T)) {
    ...
    csv <- rbind(csv, data.frame(
      ...
      p_genes_annotated_c = genes_annotated[["C"]]/n_genes_per_genome[n_genes_per_genome$genome == genome_name,"n_genes"],
      p_genes_annotated_f = genes_annotated[["F"]]/n_genes_per_genome[n_genes_per_genome$genome == genome_name,"n_genes"],
      p_genes_annotated_p = genes_annotated[["P"]]/n_genes_per_genome[n_genes_per_genome$genome == genome_name,"n_genes"],
      p_genes_annotated_a = genes_annotated[["A"]]/n_genes_per_genome[n_genes_per_genome$genome == genome_name,"n_genes"],
