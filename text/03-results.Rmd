...
dt2$genome = format_genome(dt2$genome)
headers_above = c(a = 2, b = 3, c = 3)
names(headers_above) <- c(" ", "SimGIC2", "TC-AUCPCR")
kable(dt2, booktabs=TRUE, escape=F, caption = "Quality evaluation of the used GO annotation sets.", col.names=c("Genome", "Dataset", "CC", "BF", "MP", "CC", "BF", "MP")) %>%
 kable_styling(latex_options = c("striped", "scale_down")) %>%
 add_header_above(headers_above, escape=F)%>%
