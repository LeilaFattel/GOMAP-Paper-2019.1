...
\caption{\label{tab:annotation-quantities}Quantitative metrics of the cleaned functional annotation sets. CC, MF, BP, and A refer to the aspects of the GO: Cellular Component, Molecular Function, Biological Process, and Any/All.}
\centering
\resizebox{\linewidth}{!}{
\begin{threeparttable}
